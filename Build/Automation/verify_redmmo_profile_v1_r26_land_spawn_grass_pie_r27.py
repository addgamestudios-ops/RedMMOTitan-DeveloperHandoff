"""Bounded no-save real-D3D12 PIE gate for the R26 verified land start."""
...
DIAG = Path(r"D:\RedMMOTitanWindowsData\Diagnostics\RedMMO_PPG_ProfileV1R26LandSpawnGrassPIE_R27_20260805T1210Z")
RESULT = DIAG / "result.json"
SCREENSHOT = DIAG / "player_scale_land_grass.png"
...
class R27:
    def __init__(self):
        ...
        self.report = {
            "schema": "redmmo.ppg_profile_v1.r26_land_spawn_grass.pie.r27.v1",
            "status": "RUNNING",
            "started_utc": now(),
    ...
    def set_phase(self, phase):
        ...
        unreal.log("REDMMO_R27_PHASE " + phase)
    ...
    def authenticate(self):
        ...
        require(not RESULT.exists() and not SCREENSHOT.exists(), "R27 output no-clobber failed")
        ...
        require("-d3d12" in command and "-renderoffscreen" in command and "-nullrhi" not in command, "R27 renderer gate failed")
    ...
    def finish_after_stop(self):
        ...
        self.report.update({
            "status": "PASS_R27_RUNTIME_LAND_SPAWN_MOVEMENT_GRASS_COMPONENTS_PENDING_PIXEL_REVIEW",
            ...
            "completed_utc": now(),
            "claim_limit": (
                "Runtime generation, saved-spawn grounding/radial movement and approved visible-component identity only. "
        ...
        try:
            ...
            if self.phase == "PREPARE":
                ...
                if elapsed >= FOLIAGE_SETTLE_SECONDS:
                    state = foliage_state(self.spawner)
                    self.report["runtime_foliage"] = state
                    require(state["approved_visible_grass_component_count"] > 0, "No visible approved grass component was generated")
